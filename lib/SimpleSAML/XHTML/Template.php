...
class SimpleSAML_XHTML_Template {
    ...
    function __construct(SimpleSAML_Configuration $configuration, $template, $defaultDictionary = NULL) {
        ...
        $this->translator = new SimpleSAML_XHTML_Translate($configuration, $defaultDictionary = NULL);
    }
    ...
    private function isLanguageRTL() {
        return $this->translator->isLanguageRTL();
    }
    ...
    private function getLanguageList() {
        return $this->translator->getLanguageList();
    }
